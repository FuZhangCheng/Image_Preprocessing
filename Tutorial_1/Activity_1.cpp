...
int main() {
	String input_filename = "Inputs/Videos/Love.mp4";
	...
	outputVideo.open(output_filename, VideoWriter::fourcc('D', 'I', 'V', '3'), fps, S, true);
	...
	for (int n = 0; n < totalFrame; n++) { // Extract all frames to write into a new video file
